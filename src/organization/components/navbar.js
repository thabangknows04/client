      ...
      <div className="mb-8">
        ...
        <div className="space-y-1">
          <Link 
            ...
            className={`flex items-center py-3 px-4 ${activeTab === "dashboard" ? "bg-blue-900" : "hover:bg-blue-800"} rounded-lg text-white transition-colors duration-200`}
          >
          ...
          <Link 
            ...
            className={`flex items-center py-3 px-4 ${activeTab === "events" ? "bg-blue-900" : "hover:bg-blue-800"} rounded-lg text-purple-200 transition-colors duration-200`}
          >
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link 
            ...
            className={`flex items-center py-3 px-4 ${activeTab === "guests" ? "bg-blue-900" : "hover:bg-blue-800"} rounded-lg text-purple-200 transition-colors duration-200`}
          >
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mb-8">
        ...
        <div className="space-y-1">
          <Link 
            ...
            className={`flex items-center py-3 px-4 ${activeTab === "budget" ? "bg-blue-900" : "hover:bg-blue-800"} rounded-lg text-purple-200 transition-colors duration-200`}
          >
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link 
            ...
            className={`flex items-center py-3 px-4 ${activeTab === "payments" ? "bg-blue-900" : "hover:bg-blue-800"} rounded-lg text-purple-200 transition-colors duration-200`}
          >
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link 
            ...
            className={`flex items-center py-3 px-4 ${activeTab === "security" ? "bg-blue-900" : "hover:bg-blue-800"} rounded-lg text-purple-200 transition-colors duration-200`}
          >
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div>
        ...
        <div className="space-y-1">
          <Link 
            ...
            className={`flex items-center py-3 px-4 ${activeTab === "settings" ? "bg-blue-900" : "hover:bg-blue-800"} rounded-lg text-purple-200 transition-colors duration-200`}
          >
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link 
            ...
            className={`flex items-center py-3 px-4 ${activeTab === "account" ? "bg-blue-900" : "hover:bg-blue-800"} rounded-lg text-purple-200 transition-colors duration-200`}
          >
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
