      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            {
              title: "Total Guests",
              value: eventData?.guestList?.length || 0,
            ...
            },
            {
              title: "VIP Guests",
              value:
                eventData?.guestList?.filter((g) => g.ticketType === "VIP")
                  .length || 0,
              change: `${
                eventData?.guestList?.length
                  ? `${Math.round(
            ...
            <div
              key={idx}
              className="rounded-xl shadow-md p-6 hover:shadow-xl transition-shadow text-white relative overflow-hidden"
              style={{
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm mt-1 flex items-center text-green-300">
                    <svg
